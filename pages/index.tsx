      ...
      <div className="p-6 flex justify-between items-center gap-4">
        <div className="flex items-center gap-4">
          <UserAvatar
            ...
            role={user?.role}
            size="lg"
            className="border-4 border-medical-500/20 shadow-xl"
          />
          <div>
        ...
        <Link href="/preferences" className="flex flex-col items-center justify-center p-3 bg-white dark:bg-slate-800 border-2 border-medical-200 dark:border-medical-800/60 rounded-2xl hover:bg-medical-50 dark:hover:bg-medical-900/20 shadow-lg transition-all group active:scale-95 shrink-0">
