        ...
        <div className="p-8">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input type="email" className="w-full p-4 rounded-xl border bg-white dark:bg-slate-900/50 border-slate-200 dark:border-slate-700 text-[var(--text-main)] focus:ring-2 focus:ring-indigo-500 outline-none transition-all" value={email} onChange={e => setEmail(e.target.value)} placeholder="usuario@ejemplo.com" />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full p-4 rounded-xl border bg-white dark:bg-slate-900/50 border-slate-200 dark:border-slate-700 text-[var(--text-main)] focus:ring-2 focus:ring-indigo-500 outline-none transition-all pr-12"
                  value={password}
